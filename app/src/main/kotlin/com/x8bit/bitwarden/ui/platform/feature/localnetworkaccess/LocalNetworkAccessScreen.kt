        ...
        when (event) {
            Lifecycle.Event.ON_RESUME -> {
                handler.onResumed(
                    ...
                    permissionsManager.checkPermission(Manifest.permission.ACCESS_LOCAL_NETWORK),
                )
            }
...
private fun LocalNetworkAccessContent(
    ...
    if (shouldShowPermissionDialog) {
        BitwardenTwoButtonDialog(
            title = stringResource(id = BitwardenString.access_your_local_network),
            message = stringResource(
                id = BitwardenString
                    .local_network_permission_is_required_for_communicating_with_your_local_server,
            ),
    ...
    Column(
        ...
        Text(
            text = stringResource(
                id = BitwardenString
                    .bitwarden_needs_access_to_local_networks_in_order_to_connect_and_sync_with_your_server,
            ),
        ...
        BitwardenFilledButton(
            ...
            onClick = {
                @SuppressLint("InlinedApi")
                localNetworkAccessPermissionLauncher.launch(
                    input = Manifest.permission.ACCESS_LOCAL_NETWORK,
                )
            },
            modifier = Modifier
                .fillMaxWidth()
